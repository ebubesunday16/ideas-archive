...
import { ChatBox, LadyWithLaptop, RocketLaunch } from "@/customSVG"
import Link from "next/link"

const Hero = ({className}: {className?: string}) => {
  return (
    <section className={`border-x border-b flex flex-col md:flex-row justify-between  ${className}`}>
        ...
        <div className="bg-[#CEFFF0] flex-1 px-3 sm:px-8 pt-24 pb-24 space-y-4">
            ...
            <p className="text-sm">Our team spends day and night on trends, looking for the perfect niche for the perfect dev and the perfect product
            </p>
